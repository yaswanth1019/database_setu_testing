...
SELECT create_hypertable(relation => 'bronze.raw_machine_pm_status'::regclass, time_column_name => 'ingested_at'::name, chunk_time_interval => INTERVAL '1 day');
SELECT add_retention_policy(relation => 'bronze.raw_machine_pm_status'::regclass, drop_after => INTERVAL '30 days');
