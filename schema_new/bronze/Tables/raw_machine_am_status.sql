...
SELECT create_hypertable('bronze.raw_machine_am_status', 'ingested_at', chunk_time_interval => INTERVAL '1 day');
SELECT add_retention_policy('bronze.raw_machine_am_status', INTERVAL '30 days');
